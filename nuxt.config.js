...
const BASE_PATH = process.env.NODE_ENV === 'dev' ? '/' : '/config-converter/'
...
module.exports = {
  head: {
    title: 'Config Converter - Stdtool',
    meta: [
      { charset: 'utf-8' },
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      { hid: 'description', name: 'description', content: `Config Converter. ${sets.join(", ")}.` },
      { hid: 'keywords', name: 'keywords', content: 'config,translator,converter,yaml,yml,json,ini,toml' },
